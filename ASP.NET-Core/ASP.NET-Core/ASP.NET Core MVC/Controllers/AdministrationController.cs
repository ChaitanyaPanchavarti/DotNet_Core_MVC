...
namespace ASP.NET_Core_MVC.Controllers
{
    ...
    {
        private readonly RoleManager<IdentityRole> roleManager;//RoleManager is used for managing roles in ASP.NET Core Identity.
        private readonly UserManager<ApplicationUser> userManager;//UserManager is used for managing users in ASP.NET Core Identity.
        private readonly ILogger<AdministrationController> logger;//ILogger is a logging interface provided by ASP.NET Core.
